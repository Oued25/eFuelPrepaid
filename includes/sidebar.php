    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
          <span>Gestion des Client</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="customer.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Gestion Compagnie</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="categorie.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Gestion Catégorie Produit</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="product.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Gestion Produit</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="station.php">
          <i class="fas fa-fw fa-table"></i>
          <span>Gestion station</span></a>
      </li>

      <!-- Élément de menu - Informati-->
