            ...
            <div class="row shadow">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" role="form" action="processlogin2.php" method="post">
                    <div class="form-group">
                        <input class="form-control form-control-user" placeholder="Téléphone" name="contact" type="text" autofocus>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="resetlogin.php">Mot de passe oublié !</a>
                  </div>
                </form>
                </div>
              </div>
