...
<div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
  <div class="card-header py-3">
    <h4 class="m-2 font-weight-bold text-primary">Détails Utilisateurs</h4>
  </div>
  ...
  <div class="card-body">
    ...
    $sql = "SELECT u.id AS id, nom, prenom, genre, email, nom_profil, u.date_creation, u.date_modif 
