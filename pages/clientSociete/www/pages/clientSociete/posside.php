                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nom_produit" name="nom_produit" placeholder="Montant à payer" readonly value="<?php echo $produit['nom_produit']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="stationSelection" name="station" required>
                                    <option value="" disabled selected>Choisir une station</option>
                                    <option value="fixe">Station Fixe</option>
                                    <option value="toutes">Toutes les stations</option>
                                </select>
                            </div>
                            </div>
