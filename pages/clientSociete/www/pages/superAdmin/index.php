                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            ...
                            <br>
                            <div class="button">
                                    <a href="station.php" class="btn btn-default btn-block">Voir Tous</a>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-md-12 mb-3">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Clients Sociétés</div>
                            <div class="h6 mb-0 font-weight-bold text-gray-800">1000 Enregistrer(s)</div>
                            <br>
                            <div class="button">
                                    <a href="employee.php" class="btn btn-default btn-block">Voir Tous</a>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-md-12 mb-3">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Clients Particuliers</div>
                            <div class="h6 mb-0 font-weight-bold text-gray-800">1500 Enregistrer(s)</div>
                            <br>
                            <div class="button">
                                    <a href="#" class="btn btn-default btn-block">Voir Tous</a>
                            </div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
