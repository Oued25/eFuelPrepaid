    ...
    <div class="row">
        <?php
          if ($id_compagnie){  
              ...
              $sql ='SELECT p.id AS id, code_produit, nom_produit, id_compagnie, cpa.nom_compagnie, id_categorie, nom_categorie 
                      FROM produit AS p
      ...
      <div class="col-sm-4 col-md-2">
          <form method="post" action="pos.php?action=add&id=<?php echo $produit['id']; ?>">
            <div class="products">
              ...
              <!-- Champs cachés pour la categorie -->
              <input type="hidden" name="id_categorie" value="<?php echo $produit['id_compagnie']; ?>" />
              <input type="hidden" name="nom_categorie" value="<?php echo $produit['nom_categorie']; ?>" />

              <!-- Champs cachés pour la compagnie -->
              <input type="hidden" name="id_compagnie" value="<?php echo $produit['id_compagnie']; ?>" />
              <input type="hidden" name="nom_compagnie" value="<?php echo $produit['nom_compagnie']; ?>" />
