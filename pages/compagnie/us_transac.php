...
if (isset($_POST['nom'], 
    ...
    try {
        $sql = "INSERT INTO utilisateur (nom, prenom, genre, email, mot_de_passe, id_profil, id_compagnie, id_station, date_creation, estActif)
                VALUES (:nom, :prenom, :genre, :email, :mot_de_passe, :id_profil, :id_compagnie, :id_station, NOW(), 1)";
